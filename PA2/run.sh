...
srun -N 1 --gres=gpu:1 nvprof --profile-from-start off --print-gpu-trace ./benchmark 1000
...
srun -N 1 --gres=gpu:1 nvprof --profile-from-start off --print-gpu-trace ./benchmark 10000
